...
function (_PureComponent) {
  _inherits(SidebarContent, _PureComponent);
  ...
  _createClass(SidebarContent, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)(styles.content, className);
...
Object.defineProperty(SidebarContent, "propTypes", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: {
...
var _default = (0, _reactCssModules.default)(SidebarContent, styles);
