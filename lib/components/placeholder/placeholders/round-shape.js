  ...
  _createClass(RoundShape, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          style = _props.style;
      var fullClass = [styles.round, className].filter(function (c) {
        return c;
      }).join(' ');
...
Object.defineProperty(RoundShape, "propTypes", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: {
...
var _default = (0, _reactCssModules.default)(RoundShape, styles);
