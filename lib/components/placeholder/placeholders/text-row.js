...
function (_PureComponent) {
  ...
  _createClass(TextRow, [{
    ...
    value: function render() {
      ...
      var fullClass = [styles.text, className].filter(function (c) {
        return c;
      }).join(' ');
      return _react.default.createElement("div", {
        className: fullClass,
        style: _objectSpread({}, defaultStyles, style)
      });
    }
  }]);
...
Object.defineProperty(TextRow, "propTypes", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: {
...
Object.defineProperty(TextRow, "defaultProps", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: {
...
var _default = (0, _reactCssModules.default)(TextRow, styles);
