  ...
  _createClass(RectShape, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          style = _props.style;
      var fullClass = [styles.rect, className].filter(function (c) {
        return c;
      }).join(' ');
...
Object.defineProperty(RectShape, "propTypes", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: {
...
var _default = (0, _reactCssModules.default)(RectShape, styles);
