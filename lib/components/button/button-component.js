  ...
  _createClass(Button, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          elementProps = _objectWithoutProperties(_props, ["style", "size", "disabled", "active", "onClick", "children", "type", "className"]);

      var fullClassName = (0, _classnames.default)(className, (_classNames = {}, _defineProperty(_classNames, styles[style], style), _defineProperty(_classNames, styles.isActive, active), _defineProperty(_classNames, styles[size], size), _classNames));
