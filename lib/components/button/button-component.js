  ...
  _createClass(Button, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          elementProps = _objectWithoutProperties(_props, ["style", "size", "disabled", "onClick", "children", "type", "className"]);

      var fullClassName = (0, _classnames.default)(className, (_classNames = {}, _defineProperty(_classNames, "".concat(styles[style]), style), _defineProperty(_classNames, "".concat(styles[size]), size), _classNames));
...
Object.defineProperty(Button, "propTypes", {
  ...
  value: {
    ...
    style: _propTypes.default.oneOf(['primary', 'secondary', 'clean']),
