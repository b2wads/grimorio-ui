...
var styles = {
  ...
  "label--horizontal": "form-label_label--horizontal_1hCNt",
...
function (_PureComponent) {
  ...
  _createClass(FormLabel, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)(className, styles.label, (_classNames = {}, _defineProperty(_classNames, styles['label--horizontal'], formStyleType === 'horizontal'), _defineProperty(_classNames, styles["has-".concat(validationState)], validationState), _classNames));
