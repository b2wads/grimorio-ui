...
stories.addWithInfo('Style', () => (
  <div>
    ...
    <Button style="variant">Variant</Button>&nbsp;
...
stories.addWithInfo('Modifier', () => (
  <div>
    <Button style="variant" modifier="outline">Variant --Outline</Button>&nbsp;
    <Button style="primary" modifier="outline">Primary --Outline</Button>&nbsp;
...
stories.addWithInfo('Loading', () => (
  <div>
    ...
    <Button style="variant" modifier="outline" loading>Variant --Outline</Button>&nbsp;
  </div>
));
...
stories.addWithInfo('With icon', () => (
  <div>
    ...
    <Button iconLeft="person" style="primary" modifier="outline">Outline</Button>&nbsp;
  </div>
));
...
stories.addWithInfo('States', () => (
  <div>
    ...
    <Button style="variant" modifier="outline" active>
      Active
    </Button>&nbsp;
  </div>
));
...
stories.addWithInfo('Disabled', () => (
  <div>
    ...
    <Button style="variant" modifier="outline" disabled>
      Variant Outline
    </Button>&nbsp;
  </div>
));
